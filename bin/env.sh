...
export NUMBER_OF_CHICAGO_SERVICE_INSTANCES=1;
export CHICAGO_REST_PORT="21001";
export APP_RUN="${APP_INSTALLATION_DIR}/run";
export APP_LOG="${APP_INSTALLATION_DIR}/log";
export APP_CONNECTORS_DIR="${APP_INSTALLATION_DIR}/lib/connectors";
export CHICAGO_MAIN_CLASS_NAME="";
